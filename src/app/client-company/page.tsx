...
export default function ClientCompanyPage() {
  ...
  const clients: Client[] = [
    ...
    { name: '삼성웰스토리㈜', logo: '/images/client-company/logo_client_65.png' },
    { name: '삼성엔지니어링㈜', logo: '/images/client-company/logo_client_64.png' },
    { name: '㈜LG화학', logo: '/images/client-company/logo_client_63.png' },
    { name: 'LG전자㈜', logo: '/images/client-company/logo_client_62.png' },
    { name: 'LG이노텍㈜', logo: '/images/client-company/logo_client_61.png' },
    { name: '㈜LG생활건강', logo: '/images/client-company/logo_client_60.png' },
    { name: 'SK이노베이션㈜', logo: '/images/client-company/logo_client_59.png' },
    { name: 'SK머티리얼즈 그룹14', logo: '/images/client-company/logo_client_58.png' },
    { name: 'Sk picglobal', logo: '/images/client-company/logo_client_57.png' },
    { name: 'SK매직㈜', logo: '/images/client-company/logo_client_56.png' },
    { name: '금고석유화학㈜', logo: '/images/client-company/logo_client_55.png' },
